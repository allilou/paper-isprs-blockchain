...
\abstract{
Blockchain is 
in A4 paper size 297 mm $\times$ 210 mm (11.69 $\times$ 8.27 inches). 
 \textbf{There will be no opportunity for corrections or improvements of poorly prepared originals}.  
}

\keywords{Blockchain, Decentralized Applications, Smart Contracts, Ethereum, IPFS, OrbitDB, Geospatial Data Structures, Open Standards 
}
